...
Setup
• Klona repot
• Återställ BankBlazor.bak i SQL Server
• Uppdatera connection string i BankBlazor.API/appsettings.json
• Sätt rätt API-url i BankBlazor.Client/wwwroot/appsettings.json
• Starta både API och Client
